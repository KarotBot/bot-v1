          ...
          const user = message.mentions.users.first(); 
            ...
            if (user) {
              ...
              if (member) {
                ...
                .addField('<:kt_nesuhlas:822475199755583488> Niečo sa pokazilo', 'Užívateľ ktorého chceš vyhodiť nie je na serveri.')
                .setColor('#e54918')
              ...
              .addField('<:kt_nesuhlas:822475199755583488> Niečo sa pokazilo', 'Musíš označiť užívateľa.')
              .setColor('#e54918')
